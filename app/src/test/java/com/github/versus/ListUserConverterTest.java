...
public final class ListUserConverterTest {
    private static final String strUsers = buildTestString();

    private static final List<VersusUser> users = buildTestUsers();

    private static final List<VersusUser> reverted = UserConverter.convertBackListOfUsers(strUsers);
    ...
    public void convertListOfUsersConvertsCorrectly() {
        assertEquals(UserConverter.convertListOfUsers(users), strUsers);
    }
