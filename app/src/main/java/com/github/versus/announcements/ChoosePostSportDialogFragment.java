...
public class ChoosePostSportDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage("choose a sport").setItems(Stream.of(Sport.values()).map(sport -> sport.name()).collect(Collectors.toList()).toArray(new String[0]), new DialogInterface.OnClickListener(){
                    @Override
